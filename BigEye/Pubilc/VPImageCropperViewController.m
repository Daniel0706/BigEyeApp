...
- (void)initControlBtn {
    UIView *bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 50.f, ScreenWidth, 50)];
    [self.view addSubview:bottomView];
    bottomView.backgroundColor = RGB(22, 22, 22);
...
-(UIImage *)getSubImage{
    ...
    CGFloat h = squareFrame.size.height / scaleRatio; // byzhanghe squareFrame.size.width -->>  squareFrame.size.height
